...
public class AlleLegerADMIN extends JPanel {
    ...
    public AlleLegerADMIN(Register register) {
        ...
        regLege = new RegistrerLege(this, register);
    ...
    /**
     * Metoden visAlle() viser alle registrerte leger i systemet
     *
     */
    public void visAlle() {
    ...
    public void pasientfødselsnummersøk() {

        String fnr = søkfelt.getText();
    ...
    }// pasientfødselsnummersøk ferdig
    ...
    /**
     * Legger til søkepanel
     */
    public void leggTilSøkpanel() {
        vinduer.remove(oversiktpanel);
        revalidate();
        oversiktpanel = new JPanel();
        oversiktpanel.setLayout(new BoxLayout(oversiktpanel, BoxLayout.Y_AXIS));
    ...
    /**
     * nullstiller søkefelt og viser oversiktspanel
     */
    ...
    /**
     * Lytter på musklikk, implementerer MouseListener
     */
