...
import static GUI.AlleLegerADMIN.OVERSIKT;
...
public class AllePasienterADMIN extends JPanel {
    ...
    /**
     * Viser panelet String vindu forteller hvilket vindu som skal vises
     *
     * @param vindu
     */
    ...
    /**
     * Setter radhøyde for mottatt tabell Parameter: tabell, tabell som skal
     * gjøre endringer på
     *
     * @param tabell
     */
    ...
    private class Muslytter implements MouseListener {
        ...
        private void doPop(MouseEvent e) {
            ...
            if (pasienttabell.convertRowIndexToModel(pasienttabell.getSelectedRow()) != finnesIkke) {
