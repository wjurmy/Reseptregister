...
public class VisStatistikkADMIN extends JPanel {
    ...
    public void initialiser() {
        ...
        valg1 = new JComboBox<String>(valg1Strings);
        valg2 = new JComboBox<String>(valg2Strings);
...
//        
//        fraDato.addKeyListener(new KeyListener() {
//
//            @Override
//            public void keyTyped(KeyEvent e) {
//                if (tekst.length() < 10 || e.getKeyChar() == KeyEvent.VK_BACK_SPACE) {
//                    char c;
//                    if (e.getKeyChar() == KeyEvent.VK_BACK_SPACE) {
//                        if (tekst.length() > 0) {
//                            //tekst = tekst.substring(0, tekst.length()finnesIkke);
//                            tekst = fraDato.getText();
//                        }
//                    } else {
//                        tekst += e.getKeyChar();
//                    }
//
//                    if (tekst.length() == 3) {
//                        char tre = tekst.charAt(2);
//
//                        if (tekst.charAt(2) != '-') {
//                            tekst = tekst.substring(0, 2) + "-";
//                            tekst += tre;
//                        }
//
//                    }
//                    if (tekst.length() == 6) {
//                        char seks = tekst.charAt(5);
//
//                        if (tekst.charAt(5) != '-') {
...
//        });
//
//        fraDato.addFocusListener(new FocusListener() {
//
//            @Override
//            public void focusGained(FocusEvent e) {
//                String tekst1 = fraDato.getText();
...
//                String tekst1 = fraDato.getText();
//                String mndTall = tekst.substring(3, 5);
//
//                int tall;
//
//                if (mndTall.startsWith("0")) {
//                    tall = Integer.parseInt(mndTall.substring(1));
//                } else {
//                    tall = Integer.parseInt(mndTall);
//                }
//
//                String dag = tekst.substring(0, 2);
//                String[] mnd = {"Januar", "Februar", "Mars", "April", "Main", "Juni", "Juli", "August", "September", "Oktober", "November", "Desember"};
//                String m = mnd[tall - 1];
//                String år = tekst.substring(6, 10);
//                String dato = dag + ""+ m + ""+ år;
//
...
//        });
//        
//        tilDato.addKeyListener(new KeyListener() {
//
//            @Override
//            public void keyTyped(KeyEvent e) {
//                if (tekst1.length() < 10 || e.getKeyChar() == KeyEvent.VK_BACK_SPACE) {
//                    char c;
//                    if (e.getKeyChar() == KeyEvent.VK_BACK_SPACE) {
//                        if (tekst1.length() > 0) {
//                            //tekst = tekst.substring(0, tekst.length()finnesIkke);
//                            tekst1 = tilDato.getText();
//                        }
//                    } else {
//                        tekst1 += e.getKeyChar();
//                    }
//
//                    if (tekst1.length() == 3) {
//                        char tre = tekst1.charAt(2);
//
//                        if (tekst1.charAt(2) != '-') {
//                            tekst1 = tekst1.substring(0, 2) + "-";
//                            tekst1 += tre;
//                        }
//
//                    }
//                    if (tekst1.length() == 6) {
//                        char seks = tekst1.charAt(5);
//
//                        if (tekst1.charAt(5) != '-') {
//                            tekst1 = tekst1.substring(0, 5) + "-";
//                            tekst1 += seks;
//                        }
//                    }
//                }
...
//        });
//
//        tilDato.addFocusListener(new FocusListener() {
//
//            @Override
//            public void focusGained(FocusEvent e) {
//                String tekst2 = tilDato.getText();
//
//                tilDato.setText(tekst1);
//
//            }
...
//            public void focusLost(FocusEvent e) {
//                String tekst2 = tilDato.getText();
//                String mndTall = tekst1.substring(3, 5);
//
//                int tall;
//
//                if (mndTall.startsWith("0")) {
...
//                }
//
//                String dag = tekst1.substring(0, 2);
//                String[] mnd = {"Januar", "Februar", "Mars", "April", "Main", "Juni", "Juli", "August", "September", "Oktober", "November", "Desember"};
//                String m = mnd[tall - 1];
//                String år = tekst1.substring(6, 10);
//                String dato = dag + ""+ m + ""+ år;
//
...
//        
    ...
    public void frisøkATC() {
        if (!legeIsAktiv && !pasientIsAktiv) {
            ...
            Iterator it = atcliste.iterator();

            while (it.hasNext()) {
                String atc = (String) it.next();
    ...
    public void frisøkPreparat() {
        if (!legeIsAktiv && !pasientIsAktiv) {
            ...
            Iterator it = preparatliste.iterator();

            while (it.hasNext()) {
                String preparat = (String) it.next();
    ...
    public void alleLegerAlleResepter() throws ParseException {
        ...
        Iterator alleiterator = alleLeger.iterator();

        while (alleiterator.hasNext()) {
            Lege lege = (Lege) alleiterator.next();
        ...
        TreeMap<String, Integer> sortert_legemap = new TreeMap<String, Integer>(bvc);
    ...
    public void alleLegerReseptgruppe() {
        ...
        Iterator it = alleLeger.iterator();
    ...
    public void allePasienterAlleResepter() {
        ...
        Iterator alleiterator = allePasienter.iterator();

        while (alleiterator.hasNext()) {
            Pasient pasient = (Pasient) alleiterator.next();
    ...
    public void legeAlleResepter() {
        ...
        HashMap<String, Integer> map = new HashMap<>();
        ValueComparator bvc = new ValueComparator(map);
        TreeMap<String, Integer> sortert_map = new TreeMap<String, Integer>(bvc);
