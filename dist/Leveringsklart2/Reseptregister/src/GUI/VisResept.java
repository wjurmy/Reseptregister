...
/**
 * Dokumentasjon for resept. 
 * Viser informasjon om resepten dersom det skulle være behov for dokumentering.
 */
...
public class VisResept extends JPanel {
     ...
     * @param resept resept som skal vises
     */
     ...
     * @param icon filsti til knappen som skal vises
