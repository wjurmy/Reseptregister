/**
 * Klassen EndreLegeADMIN er en JDialog som inneholder tekstfelter og Check bokser som inneholder
 * Informasjon om legen. Dialogboksen brukes til å gjøre endringer i informasjon om legen.
 */
package GUI;
...
public class EndreLegeADMIN extends JDialog {
     ...
     *
     * @param lege legen som skal endres
     * @param parent en instanse av AlleLegerADMIN
     */
