/**
 * Viser en dialog for registrering av ny resept
 */
package GUI;
...
public class NyResept extends JDialog {
     ...
     *
     * @param pasient passient som skal registrers resept på
     * @param lege Lege som er logget inn i systemet som skal skrive ut resept
     * @param parent instans av foreldreklassen VisPasient
     * @param parent2 instans av foreldreklassens foreldreklasse MainFrame
     */
    ...
    /**
     * Registrerer ny resept dersom legen har auytorisasjon og alle felter er fyllt ut korrekt
     */
    ...
    /**
     * Lager feltpanel for tekstfelter for registrering av resept
     */
