...
public class VisPasient extends JPanel {
     ...
     * @param parent instanse av klassen MainFrame
     */
    ...
    public void nyResept() {
        ...
        String[] valg = {"Jeg har sjekket", "Nei"};


        if (resepter.getAntallTotalt(pasient.getID()) != 0) {
            int svar = JOptionPane.showOptionDialog(null, "Har du sjekket at preparatet du vil skrive ut ikke allerede er skrevet ut av en anne lege?", "Har du sjekket?",
                    JOptionPane.YES_NO_OPTION,
                    JOptionPane.PLAIN_MESSAGE,
                    null,
                    valg, // this is the array
                    valg[1]);
     ...
     * Viser vinduet vindu
     *
     * @param vindu vinduet som skal vises
     */
     ...
     * @param rollover rollovericom som skal vises når musa er over knappen
     * @return bildeknapp
     */
