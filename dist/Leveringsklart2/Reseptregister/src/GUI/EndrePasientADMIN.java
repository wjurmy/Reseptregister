/**
 * Klassen EndrePasientADMIN endrer infpormasjonen til en pasient
 * Klassen arver et JPanel som inneholder all informasjon om pasient
 * Klassen innholder også en tabell med alle leger in systemet sånn at pasienten kan få ny fastlege
 */
package GUI;
 ...
 * @author Walid Jurmy og Benjamin Aarstad Nygård
 */
public class EndrePasientADMIN extends JPanel {
     ...
     *
     * @param pasient passienten som skal endres
     * @param register instans av Register klassen
     * @param parent instans av AllePasienterADMIN klassen
     * @param grandparent instans av AllePasienter
     */
    ...
    /**
     * Setter høyde på tabellen som er tatt imot som parameter, endrer også skrift og størrelse
     *
     * @param tabell tabell som skal gjøres endringer på
     */
    ...
    /**
     * Viser alle pasienter i systemet etter at søket er blitt nullstilt
     */
    public void visAlle() {
    ...
    /**
     * Metode for å søke med fritekst i legeregisteret
     * metoden kjører over hele legeregisteret og viser alle leger om matcher et gitt søk
     */
    public void frisøk() {
