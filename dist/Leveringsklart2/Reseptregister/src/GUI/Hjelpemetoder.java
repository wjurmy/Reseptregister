...
public class Hjelpemetoder {
     ...
     * osv.
     *
     * @param navn navn som skal konverteres til riktig navn
     * @return navn - ferdig konvertert navn 
     */
     ...
     *
     * @param register  instans av Preparatregister
     * @param atc_kode atckode for preparatet 
     * @return preparatnavnet - Dersm den ble funnet 
     */
     ...
     *
     * @param kode ATC kode til preparatet som skal hentes
