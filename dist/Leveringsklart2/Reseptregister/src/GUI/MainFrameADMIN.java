/**
 * MainFrameADMIN inneholder tre knapper. Statistikk, Lege og pasient.
 * For å vise statistikk, lege eller pasient trykkes den ønskede knappen og det vises på skjermen
 */
package GUI;
 ...
 * @author Vegard Lokreim og Walid Jurmy
 */
public class MainFrameADMIN extends JFrame {
     ...
     *
     * @param register instans av Register
     * @param generator instans av Statistikkgenerator
     */
     ...
     *
     * @param icon filsti til bildet som skal legges til
    ...
    /**
     * Legger til lukk/minimerknapp og setter JFrame til undecorated
     */
     ...
     * @param rolloverIcon filsti til rolloverbildet
     * @param tooltip string med tekst som skal vises dersom musa er over knappen 
     * @return bildeknapp - knapp med bilde
     */
     ...
     * Dersom statistikkpanel vises så spørres brukeren omm det er ønskelig å bytte vindu
     *
     * @param vindu nanvet på vinduet som skal vises
     */
    ...
    /**
     * Får fram loginvinduet etter at vindeut er lukket
     */
    public void login() {
